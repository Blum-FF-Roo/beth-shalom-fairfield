...
export default async function JudaismPage() {
  // Fetch content server-side with a fallback. The whole page is a single
  // rich-HTML block (headings included) so it's editable as one document
...
<p>Free audio clips to learn Beth Shalom Services at <a href="http://www.sidduraudio.com/" class="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">SiddurAudio.com</a></p>

<p>Hebrew Prayer, Shabbat services, Jewish weekday, and Passover Seder – Download Sound Clips Online</p>

<p>Beth Shalom's president, Mark Berkowitz, reports, "This is an unbelievable free resource. Learn any and all synagogue services online free. From the same Siddur Sim Shalom we use at Beth Shalom. They have a sister site where you can learn any haftorah the same way. The cantor has a sweet voice that's reminiscent of our very own Rabbi Alan Green; delightful to listen to."</p>

<p>"Even if your Hebrew reading skills are low, you can still learn by singing along with the familiar melodies. It's actually a great way to improve your Hebrew reading skills. No more excuses for phumfering along during services."</p>

<h2>Do you light Shabbat candles?</h2>
...
<p class="italic">Go to FRIDAY LIGHT at <a href="http://fridaylight.org/page/new-index.php" class="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">fridaylight.org</a> for a beautiful website presentation on lighting Shabbos candles.</p>

<div class="bg-blue-50 p-4 rounded-lg italic">
...
<h2>Tablet Magazine</h2>
<p>Do you know of the online Tablet Magazine? It's a free, online digest of articles (and <a href="http://www.tabletmag.com/podcasts/" class="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">podcasts</a>) on Jewish culture, arts and literature.</p>

<p>Check out: Tu B'Shevat FAQ. Everything you ever wanted to know about the arboreal holiday.</p>
...
<p class="italic">"When you come to the land and you plant any tree, you shall treat its fruit as forbidden; for three years it will be forbidden and not eaten. In the fourth year, all of its fruit shall be sanctified to praise the L-RD. In the fifth year, you may eat its fruit." -Leviticus 19:23-25</p>
</div>

<div class="bg-blue-50 p-4 rounded-lg">
<p class="italic">"There are four new years… the first of Shevat is the new year for trees according to the ruling of Beit Shammai; Beit Hillel, however, places it on the fifteenth of that month." –Mishnah Rosh Hashanah 1:1</p>
</div>
...
<h2>Is Reconstructionist Judaism For You?</h2>
...
<h2>Yahrzeit Candle / Yizkor Service</h2>
<p class="italic">"The soul of man is the light of God."</p>
...
<p class="italic">Recite whatever prayer is in your heart; the prayers of the heart are especially precious to God.</p>

<h2>"WHY DO I HAVE TO GO TO HEBREW SCHOOL?" (What does Being Jewish mean?")</h2>
