        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Thank you {paymentDetails.payer?.name?.given_name || 'for your membership'}!
            </p>
            ...
            <p className="text-gray-600 mb-6">
              Your membership has been processed successfully. You will receive a confirmation email shortly with your membership details and next steps.
            </p>
            <button
              onClick={() => {
