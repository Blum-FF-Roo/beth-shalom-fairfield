...
import { useMultipleContent } from '@/hooks/useContent';

export default function AboutPage() {
  const { content, loading } = useMultipleContent([
    'aboutAdministration',
    'aboutBoardMembers', 
    'aboutCommittees',
    'aboutResources',
    ...
    aboutAdministration: `<h2>ADMINISTRATION</h2>
...
<p><strong>Treasurer:</strong> Fred Swartz</p>
    ...
    aboutCommittees: `<p><strong>Building:</strong> Sol Waksman, Bill Pollak</p>
...
<p><strong>Volunteers:</strong> Brian Teitzman</p>`,
    aboutResources: `<p><strong>Beth Shalom Newsletter:</strong> To receive the weekly Beth Shalom Newsletter or to update your newsletter email address contact us at bethshalomfairfield@gmail.com</p>
...
<p><strong>Information:</strong> Contact Marc Berkowitz at 472-9509 or email bethshalomfairfield@gmail.com</p>`,
    aboutCommunityMessage: `<p>On these special occasions, where we come together as a Jewish community, we particularly appreciate being able to have our own Synagogue, a place to pray to together, to celebrate together, and to affirm our faith. Even though we know that God is everywhere, when we come together to pray just as our ancestors have done for thousands of years, we are enlivening Abraham's covenant with God, for all Jews for all time, and enlivening our own relationship with God.</p>
      ...
      <div className="min-h-screen pt-32 pb-12 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="animate-pulse">
            <div className="h-12 bg-gray-300 rounded mb-8 w-96 mx-auto"></div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <div 
            ...
            dangerouslySetInnerHTML={{ __html: content.aboutAdministration || '' }}
          />
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-gray-700">
            {(content.aboutBoardMembers as string[] || []).map((member: string, index: number) => (
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div 
            ...
            dangerouslySetInnerHTML={{ __html: content.aboutCommittees || '' }}
          />
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div 
            ...
            dangerouslySetInnerHTML={{ __html: content.aboutResources || '' }}
          />
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div 
            ...
            dangerouslySetInnerHTML={{ __html: content.aboutCommunityMessage || '' }}
          />
        </div>
      </div>
    </div>
