...
const categories = [
  ...
  { value: 'services', label: 'Services (general)' },
  { value: 'shabbat', label: 'Services - Shabbat' },
  { value: 'high-holy-days', label: 'Services - High Holy Days' },
  { value: 'passover', label: 'Services - Passover' },
